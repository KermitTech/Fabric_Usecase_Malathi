...
# === CONFIGURATION ===
bronze_table_path = "abfss://Malathi@onelake.dfs.fabric.microsoft.com/Bronze.Lakehouse/Tables/bronze/Account"
silver_table_path = "abfss://Malathi@onelake.dfs.fabric.microsoft.com/Bronze.Lakehouse/Tables/silver/Account"
gold_table_path = "abfss://Malathi@onelake.dfs.fabric.microsoft.com/Bronze.Lakehouse/Tables/gold/Account"
temp_table_path = "abfss://Malathi@onelake.dfs.fabric.microsoft.com/Bronze.Lakehouse/Tables/bronze/Account_temp"
backup_table_path = f"abfss://Malathi@onelake.dfs.fabric.microsoft.com/Bronze.Lakehouse/Tables/gold/Account_backup"
log_table_path = "abfss://Malathi@onelake.dfs.fabric.microsoft.com/Bronze.Lakehouse/Tables/gold/Load_Auditlogs"

# === INIT LOG VARIABLES ===
log_time = datetime.now()
log_operation = "Account Data Load"
log_status = "Started"
