...
# === CONFIGURATION ===
bronze_table_path = "abfss://Malathi@onelake.dfs.fabric.microsoft.com/Bronze.Lakehouse/Tables/bronze/sales"
silver_table_path = "abfss://Malathi@onelake.dfs.fabric.microsoft.com/Bronze.Lakehouse/Tables/silver/sales"
gold_table_path = "abfss://Malathi@onelake.dfs.fabric.microsoft.com/Bronze.Lakehouse/Tables/gold/sales"
temp_table_path = "abfss://Malathi@onelake.dfs.fabric.microsoft.com/Bronze.Lakehouse/Tables/bronze/sales_temp"
backup_table_path = f"abfss://Malathi@onelake.dfs.fabric.microsoft.com/Bronze.Lakehouse/Tables/gold/sales_backup"
log_table_path = "abfss://Malathi@onelake.dfs.fabric.microsoft.com/Bronze.Lakehouse/Tables/gold/Load_Auditlogs"

# === INIT LOG VARIABLES ===
log_time = datetime.now()
log_operation = "Data Load"
log_status = "Started"
