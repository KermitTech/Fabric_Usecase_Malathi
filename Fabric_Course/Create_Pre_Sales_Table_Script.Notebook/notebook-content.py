...
# META   "dependencies": {
# META     "lakehouse": {
# META       "default_lakehouse": "9c3d1e3c-2765-4802-a6d4-f06f058e36bd",
...
table_path = 'abfss://Malathi@onelake.dfs.fabric.microsoft.com/Bronze.Lakehouse/Tables/Supply_Chain/raw_sales'
...
if not DeltaTable.isDeltaTable(spark, table_path):
    ...
    spark.sql(f"""
        CREATE TABLE IF NOT EXISTS Supply_Chain.raw_sales (
            transaction_id INT,
            product_id STRING,
            store_id STRING,
            sale_date TIMESTAMP,
