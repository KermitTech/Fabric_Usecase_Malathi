...
# META   "dependencies": {
# META     "lakehouse": {
# META       "default_lakehouse": "cc56555c-7ead-4ad1-88e7-f43484ce6ef0",
...
# META         },
# META         {
# META           "id": "cc56555c-7ead-4ad1-88e7-f43484ce6ef0"
# META         }
# META       ]
# META     }
# META   }
...
sales_df = spark.read.format("delta").load(
    "abfss://Malathi@onelake.dfs.fabric.microsoft.com/Bronze_Layer.Lakehouse/Tables/dbo/raw_sales"
)
sales_df.show()
...
table_name = "abfss://Malathi@onelake.dfs.fabric.microsoft.com/Silver_Layer.Lakehouse/Tables/dbo/cleansed_sales_data"  # Example of a table name
